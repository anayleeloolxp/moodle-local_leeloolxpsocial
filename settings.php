...
if ($hassiteconfig) {
    require_once($CFG->dirroot . '/local/leeloolxpsocial/lib.php');
    $settings = new admin_settingpage('local_leeloolxpsocial', get_string('setting_title', 'local_leeloolxpsocial'));
